...
```bash
export DATABASE_URL="postgresql+asyncpg://user:password@localhost:5432/product_catalog"
...
See Docker and deployment configuration files:
...
### Adding Bulk Create / Update

Future tasks will add:
- `POST /products/bulk` - Bulk create with API key auth
